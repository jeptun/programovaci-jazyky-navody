  ...
  return (
    <header className="sticky-top  bg-white">
      <div className="flex-shrink-0 p-3  ">
        ...
        >
          <svg className="bi me-2" width="50" height="50" viewBox="0 0 25 25">
            <path
          ...
          <span className="fs-5 fw-semibold">ES6 Návod</span>
        </NavLink>
        ...
        {/* <ul className="list-unstyled ps-0 d-sm-block d-flex nav-scroller ">
          <li className="mb-1 ">
            <button
              className="btn btn-toggle align-items-center rounded collapsed"
              data-bs-toggle="collapse"
              data-bs-target="#variables-collapse"
              aria-expanded="false"
            >
              Proměnné
            </button>
            <div className="collapse" id="variables-collapse">
